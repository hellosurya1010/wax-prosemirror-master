...
const TextHighlightingTool = ({ view: { dispatch, state }, item }) => {
  ...
  const highlightDropDownOptions = [
    { name: 'Author', value: '#F3E95C' },
    { name: 'Title', value: '#7DE5DB' },
    { name: 'DOI', value: '#C0EB96' },
    { name: 'Surname', value: '#F2C4D1' },
    { name: 'Given', value: '#FFB56B' },
    { name: 'Book', value: '#FF8080' },
    { name: 'Issue', value: 'transparent' },
  ];
